 ...
 */
class getProduitCommandeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProduitCommandeRepository' shared autowired service.
     *
     * @return \App\Repository\ProduitCommandeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProduitCommandeRepository.php';

        return $container->privates['App\\Repository\\ProduitCommandeRepository'] = new \App\Repository\ProduitCommandeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
